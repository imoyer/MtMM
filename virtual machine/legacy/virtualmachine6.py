...
##        serport.read()
        ...
        return (outgoing, realduration)


    def simmove(self, outgoing, realduration):
        ...
        return [delta, rate, movetime, realduration]
...
for i in range(0,len(localcomputer.movetable)):
	...
	if nomove != 1:
		[outgoing, realduration] = machinecontroller.xmit()
		[delta, rate, movetime, realmovetime] = machinecontroller.simmove(outgoing, realduration)
		print "MOVE COMPLETE"
		print "EXPECTED DURATION: ", movetime
		print "ACTUAL DURATION: ", realmovetime
	else:
